---
title: "How Therapists and Counselors Can Use Client Testimonials Ethically"
description: "Collecting testimonials as a therapist feels ethically complicated — but it doesn't have to be. Here's how to do it in a way that respects client privacy and still builds real trust with prospective clients."
...
For gathering your own testimonials that you control (anonymous, text-only, on your own site), a tool like [SocialProof](https://socialproof.dev) gives you more flexibility than Google Reviews — you control what's published and can keep attributions completely anonymous.
...
1. Create a free account at [SocialProof](https://socialproof.dev)
