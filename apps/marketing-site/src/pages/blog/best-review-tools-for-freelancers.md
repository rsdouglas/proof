...
[SocialProof](https://socialproof.dev) is purpose-built for small businesses and freelancers. The core flow is dead simple:

1. Get a shareable collection link
2. Send it to clients
3. Approve submissions
4. Embed a live widget on your portfolio
...
1. **Sign up for SocialProof** (free, no card) at [socialproof.dev](https://socialproof.dev)
2. **Create a widget** and grab your collection link
3. **Email your last 5 clients** asking for a testimonial using the link
4. **Approve submissions** as they come in
5. **Embed the widget** on your portfolio's homepage and/or services page
