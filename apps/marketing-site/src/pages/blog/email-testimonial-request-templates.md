...
slug: "email-testimonial-request-templates"
---
...
All of them link to a SocialProof collect link — a short form your customer fills out in 2 minutes, no login required.
...
1. **Day 5:** One follow-up (Template 2) if no response
1. **Day 12:** If still no response, let it go — move to the next customer
...
When a customer submits via your SocialProof collect link, the testimonial goes into your dashboard pending queue. You approve it (or don't), and approved testimonials appear on your embedded widget automatically. No copy-pasting, no editing your website.
...
` ` Works on any website: Squarespace, Shopify, WordPress, Webflow, custom HTML, or anything else that accepts JavaScript.
 ...
 Get your collect link — it's free
...
- [Google Reviews vs. Direct Testimonials: Which Should You Collect?](/blog/google-review-alternative)
- [What Customers Want to See Before They Buy](/blog/what-customers-want-to-see-before-they-buy)
