...
1. [What is social proof, really?](#what-is)
1. [Why it matters more for small businesses than big ones](#why-matters)
1. [6 types of social proof (with examples)](#types)
1. [How to collect social proof (without begging)](#collecting)
1. [Where to show it on your website](#where-to-show)
1. [3 mistakes most small businesses make](#common-mistakes)
1. [Getting started today](#getting-started)
...
The most powerful form for most small businesses. A real quote from a real customer, ideally with a name, photo, and specific outcome. "I used to spend 4 hours writing proposals. Now I do it in 20 minutes." Specific beats generic every time.
 ...
 — Marcus T., freelance designer, Chicago
...
> **Want the full email templates?** We wrote 7 copy-paste testimonial request emails for every business type: [Testimonial Request Email Templates →](/blog/testimonial-email-templates)
...
- **Homepage hero section** — put 2–3 testimonials directly under your main headline. This is where people decide in 10 seconds whether to read on.
- **Pricing page** — right next to (or inside) your pricing tiers. This is the highest-anxiety moment. Address concerns immediately.
- **Checkout or contact form** — just before the final commitment. "7,000 customers agree" or a specific testimonial about the buying experience.
- **Below the fold on any page** — as people scroll, show them more evidence. They're already interested; help them commit.
- **Near your objection-handling copy** — if you say "our pricing is higher because of X," a testimonial from someone who paid it and found it worth it is 10× more credible than you saying it.
...
1. Send them one of the [email templates](/blog/testimonial-email-templates) with a link to your testimonial form
1. Add the testimonials you receive to your homepage and pricing page this week
1. Set a monthly reminder to ask recent customers
