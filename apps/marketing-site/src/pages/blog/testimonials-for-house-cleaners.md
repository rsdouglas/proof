...
1. After every first clean, an automated text goes out via [Proof](https://socialproof.dev) or your CRM
2. Happy responses get prompted for a Google review
3. Unhappy responses get a follow-up call from you to resolve

This turns your entire client base into a review machine.

## Collect Testimonials With Proof

[Proof](https://socialproof.dev) gives you a simple link to send clients after each clean. They leave a testimonial in 60 seconds, and it displays in a widget on your booking page. Free forever for 1 active widget.

---

*Related: [How to Collect Customer Testimonials](/blog/how-to-collect-testimonials) | [Social Proof for House Cleaners](/for/house-cleaners)*
